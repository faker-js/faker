...
If you want consistent results, you can set your own seed. There are additional considerations if using `faker.date` methods, see [Reproducible Results](https://fakerjs.dev/guide/usage.html#reproducible-results).
