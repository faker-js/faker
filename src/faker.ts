...
import { AttractionModule } from './modules/attraction';
...
import { FurnitureModule } from './modules/furniture';
...
export class Faker {
  ...
  readonly attraction: AttractionModule = new AttractionModule(this);
  ...
  readonly furniture: FurnitureModule = new FurnitureModule(this);
  ...
  readonly kitchen: KitchenModule = new KitchenModule(this);
