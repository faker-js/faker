export default [
  ...
  { symbol: 'O', name: 'Oksygen', atomicNumber: 8 },
  ...
  { symbol: 'Si', name: 'Silisium', atomicNumber: 14 },
  { symbol: 'P', name: 'Fosfor', atomicNumber: 15 },
  { symbol: 'S', name: 'Svovel', atomicNumber: 16 },
  ...
  { symbol: 'Ti', name: 'Titan', atomicNumber: 22 },
  { symbol: 'V', name: 'Vanadium', atomicNumber: 23 },
  { symbol: 'Cr', name: 'Krom', atomicNumber: 24 },
  { symbol: 'Mn', name: 'Mangan', atomicNumber: 25 },
  { symbol: 'Fe', name: 'Jern', atomicNumber: 26 },
  { symbol: 'Co', name: 'Kobolt', atomicNumber: 27 },
  { symbol: 'Ni', name: 'Nikkel', atomicNumber: 28 },
  { symbol: 'Cu', name: 'Kobber', atomicNumber: 29 },
  { symbol: 'Zn', name: 'Sink', atomicNumber: 30 },
  ...
  { symbol: 'Zr', name: 'Zirkonium', atomicNumber: 40 },
  { symbol: 'Nb', name: 'Niob', atomicNumber: 41 },
  { symbol: 'Mo', name: 'Molybden', atomicNumber: 42 },
  ...
  { symbol: 'Ag', name: 'Sølv', atomicNumber: 47 },
  { symbol: 'Cd', name: 'Kadmium', atomicNumber: 48 },
  { symbol: 'In', name: 'Indium', atomicNumber: 49 },
  { symbol: 'Sn', name: 'Tinn', atomicNumber: 50 },
  { symbol: 'Sb', name: 'Antimon', atomicNumber: 51 },
  ...
  { symbol: 'Pr', name: 'Praseodym', atomicNumber: 59 },
  ...
  { symbol: 'Pt', name: 'Platina', atomicNumber: 78 },
  { symbol: 'Au', name: 'Gull', atomicNumber: 79 },
  { symbol: 'Hg', name: 'Kvikksølv', atomicNumber: 80 },
  { symbol: 'Tl', name: 'Thallium', atomicNumber: 81 },
  { symbol: 'Pb', name: 'Bly', atomicNumber: 82 },
  { symbol: 'Bi', name: 'Vismut', atomicNumber: 83 },
  ...
  { symbol: 'Rg', name: 'Røntgenium', atomicNumber: 111 },
  ...
  { symbol: 'Ts', name: 'Tenness', atomicNumber: 117 },
