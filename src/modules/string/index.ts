 ...
 *
 * For strings of digits, use [`numeric()`](https://next.fakerjs.dev/api/string.html#numeric) (or for other bases, [`binary()`](https://next.fakerjs.dev/api/string.html#binary), [`octal()`](https://next.fakerjs.dev/api/string.html#octal) or [`hexadecimal()`](https://next.fakerjs.dev/api/string.html#hexadecimal)).
 *
 * You can also generate standard ID strings using [`uuid()`](https://next.fakerjs.dev/api/string.html#uuid) or [`nanoid()`](https://next.fakerjs.dev/api/string.html#nanoid).
 *
 * ### Related modules
 *
 * - Emoji can be found at [`faker.internet.emoji()`](https://next.fakerjs.dev/api/internet.html#emoji).
 * - The [`faker.helpers`](https://next.fakerjs.dev/api/helpers.html) module includes a number of string related functions.
 */
