...
export class HelpersModule {
   ...
   *
   * ```js
   * const message = faker.helpers.fake('Your pin is {{string.numeric(4)}}.')
   * ```
   *
   ...
   * faker.helpers.fake('I rolled the dice and got: {{string.numeric(1)}}') // 'I rolled the dice and got: 6'
   *
   * @since 7.4.0
   */
