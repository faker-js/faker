 ...
 *
 * For a hex color like `#ff0000` used in HTML/CSS use [`rgb()`](https://next.fakerjs.dev/api/color.html#hex). There are also methods for other color formats such as [`hsl()`](https://next.fakerjs.dev/api/color.html#hsl), [`cmyk()`](https://next.fakerjs.dev/api/color.html#cmyk), [`hwb()`](https://next.fakerjs.dev/api/color.html#hwb), [`lab()`](https://next.fakerjs.dev/api/color.html#lab) and [`lch()`](https://next.fakerjs.dev/api/color.html#lch).
 */
