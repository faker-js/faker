 ...
 *
 * loremParagraphs(fakerCore, 2, '<br/>\n')
 ...
 *
 * loremParagraphs(fakerCore, { min: 1, max: 3 })
 ...
 * @experimental
 */
export function loremParagraphs(
  fakerCore: FakerCore,
  paragraphCount: NumberOrRange = 3,
  separator: string = '\n'
): string {
  return helpersMultiple(fakerCore, () => loremParagraph(fakerCore), {
