 ...
 *
 * In order of increasing size you can generate a single [`word()`](https://next.fakerjs.dev/api/lorem.html#word), multiple [`words()`](https://next.fakerjs.dev/api/lorem.html#words), a [`sentence()`](https://next.fakerjs.dev/api/lorem.html#ence), multiple [`sentences()`](https://next.fakerjs.dev/api/lorem.html#sentences) or [`lines()`](https://next.fakerjs.dev/api/lorem.html#lines) (seperated by newlines), one [`paragraph()`](https://next.fakerjs.dev/api/lorem.html#paragraph) or multiple [`paragraphs()`](https://next.fakerjs.dev/api/lorem.html#paragraphs).
 *
