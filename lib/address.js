...
var address = {
    ...
    nearbyLocation: function(location, radius, isMetric) {
        ...
        function boundaryLocation(location, bearing, distance, isMetric) {
            ...
            lat1 = degreesToRadians(location[0]); //Current lat point converted to radians
            lon1 = degreesToRadians(location[1]); //Current long point converted to radians
        ...
        // This is a heuristic to approximate the circular region defined by location and radius.
        topLeftBoundary = boundaryLocation(location, degreesToRadians(45), radius, isMetric);
        bottomRightBoundary = boundaryLocation(location, degreesToRadians(45), -radius, isMetric);
